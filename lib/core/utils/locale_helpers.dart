...
class KurdishSafeMaterialDelegate extends LocalizationsDelegate<MaterialLocalizations> {
...
class KurdishSafeCupertinoDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
